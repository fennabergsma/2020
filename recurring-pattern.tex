competes ains]% !TEX root = thesis.tex
...
To sum up, case competition in headless relative is subject to the case scale, repeated from the introduction of this chapter in \ref{ex:case-scale-rep}.
