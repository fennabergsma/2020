...
If the internal case and the external case are the same case, the relative pronoun simply surfaces in that case. I illustrate this with examples from headless relatives in Gothic. The cases I discuss are nominative, accusative and dative.
...
The external case is nominative as well, as the predicate \tit{ga-dauþnan} `to die' also takes nominative subjects.
...
The external case is accusative as well, as the predicate \tit{ga-arman} `to pity' also takes accusative objects.
...
The external case is dative as well, as the predicate \tit{giban} `to give' also takes dative indirect objects.
...
I start with the competition between accusative and nominative. Following the case scale in \ref{ex:case-scale}, the relative pronoun appears in the accusative case and never in nominative.
...
I continue with the competition between dative and nominative. Following the case scale in \ref{ex:case-scale}, the relative pronoun appears in the dative case and never in nominative.
...
I end with the competition between dative and accusative. Following the case scale in \ref{ex:case-scale}, the relative pronoun appears in the dative case and never in accusative.
