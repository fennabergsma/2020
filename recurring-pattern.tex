...
If the internal and the external case are identical, nothing special happens: the relative pronoun simply surfaces in that case. I illustrate this with examples from headless relatives in Gothic. I give examples in which the internal and external case are respectively nominative, accusative and dative. The relative pronoun appears in the respective cases.
...
The internal case is accusative, as the predicate \tit{manwjan} `to prepare' takes dative indirect objects.
The external case is accusative as well, the predicate \tit{giban} `to give' takes dative indirect objects.
The relative pronoun \tit{þan(a)} `\ac{rel}.\ac{sg}.\ac{m}.\ac{acc}' appears in the internal and external case: the accusative.
