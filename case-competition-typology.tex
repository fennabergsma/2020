...
\a. The internal-and-internal type: the internal and the external case are allowed to surface when either of them wins the case competition\label{ex:int-ext}
...
\b. The matching type: the case is only allowed to surface when it is both the internal and external case (i.e. when the cases match)\label{ex:matching}
