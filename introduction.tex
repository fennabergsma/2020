...
The relative pronoun \tit{þan(a)} `\ac{rel}.\ac{sg}.\ac{m}.\ac{acc}' appears in accusative case.\footnote{
...
Now I return to the question where \tit{þan(a)} `\ac{rel}.\ac{sg}.\ac{m}.\ac{acc}' in \ref{ex:gothic-acc-acc} got its case from. In the remainder of this section I show evidence for the claim that the relative pronoun is sensitive to both the internal and the external case.
