...
The external case is accusative, as the predicate \tit{tōbrȳsan} `pulversize' takes accusative objects.
...
I added one parameters.


The first parameter, \tit{cases considered}, concerns which cases are considered to surface on the relative pronoun. This parameter distinguishes the always-external type of language from the matching, the internal-only and the unrestricted type of languages.
