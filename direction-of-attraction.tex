      ...
      \begin{minipage}{\linewidth}
        \begin{tabularx}{\textwidth}{c|Y|Y|Y|Y}
          \toprule
            ...
            V\scsub{nom} 		                                 & \colorbox{LightGray}{\tsc{nom}} 			                                    & \diagbox[linecolor=white]{*\tsc{nom}}{*\tsc{acc}} 	              & \diagbox[linecolor=white]{*\tsc{nom}}{*\tsc{dat}} 	                & \diagbox[linecolor=white]{*\tsc{nom}}{*\tsc{gen}} 	\\ \cmidrule(lr){1-5}
            V\scsub{acc} 		                                 & \diagbox[linecolor=white]{\colorbox{DarkGray}{\tsc{acc}}}{*\tsc{nom}} 	&	\colorbox{LightGray}{\tsc{acc}} 		                                   	&	\diagbox[linecolor=white]{*\tsc{acc}}{*\tsc{dat}} 	                &	\diagbox[linecolor=white]{*\tsc{acc}}{*\tsc{gen}}   \\ \cmidrule(lr){1-5}
            V\scsub{dat} 		                                 & \diagbox[linecolor=white]{\colorbox{DarkGray}{\tsc{dat}}}{*\tsc{nom}}	  &	\diagbox[linecolor=white]{\colorbox{DarkGray}{\tsc{dat}}}{*\tsc{acc}} & \colorbox{LightGray}{\tsc{dat}} 			                                    & \diagbox[linecolor=white]{*\tsc{dat}}{*\tsc{gen}}	  \\ \cmidrule(lr){1-5}
            V\scsub{gen} 		                                 & \diagbox[linecolor=white]{\colorbox{DarkGray}{\tsc{gen}}}{*\tsc{nom}} 	& \diagbox[linecolor=white]{\colorbox{DarkGray}{\tsc{gen}}}{*\tsc{acc}} & \diagbox[linecolor=white]{\colorbox{DarkGray}{\tsc{gen}}}{*\tsc{dat}} 	& \colorbox{LightGray}{\tsc{gen}}				                  \\
          \bottomrule
        \end{tabularx}
      \end{minipage}
  \end{table}
