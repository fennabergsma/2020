...
Just like in Gothic and Old High German, the Modern German relative pronoun is sensitive to the internal and external case. Modern German differs crucially from Gothic and Old High German in that its headless relative are only grammatical when the internal case wins the case competition over the external case. In other words, the relative pronoun can only surface in the internal case, so the case of the relative clause. I interpret this as follows: the relative pronoun is part of the relative clause and it can license a smaller case in the main clause.

Evidence for the relative pronoun being in the relative clause is Modern German does not only come from the case facts, but also from the shape of the relative pronoun. The relative pronoun in Modern German is a \tsc{wh}-pronoun. \tsc{wh}-pronouns in Modern German typically appear at the left edge of the clause. X is an example of a \tsc{wh} in nominative.

\exg. Was machst du?\\
 \\
 `'

But also accusatives, see X, which as non-\tsc{wh} do not appear at the left edge of the clause.
...
--give headless relative example--

--now give a tree with acc in the left periphery, as part of the relative clause--
