...
But how does it license this external nominative?
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item For headless relatives: it is needed to distinguish German from Polish %for this we need the wh-property..
  \end{itemize}
