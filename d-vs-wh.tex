...
Independent from these case facts, I provide three arguments why the headless relative pronoun in Modern German is part of the relative clause. The first one is extraposition in headless relatives, the second one is relative pronouns in general and the last one is \tsc{wh}-elements in general.

The strongest argument for the headless relative pronoun being part of the relative clause comes from extraposition in headless relatives. In Modern German, it is possible to extrapose a clause (a CP), but not a noun phrase (DP). This is illustrated in \ref{ex:mg-extrapose-cp} and \ref{ex:mg-extrapose-dp}.

The sentence in \ref{ex:mg-extrapose-cp-base} contains a clausal object, marked here in bold. This objects can be extraposed to the right edge of the clause, shown in \ref{ex:mg-extrapose-cp-moved}.
...
This does not work with the same sentence, only replacing the sentential object by a simple noun phrase. blabla
...
Now \ref{ex:extra-headless} shows two examples with headless relative clause extraposition. The relative clause can be extraposed, showing that the relative pronoun is part of a CP. If it was not in the CP, it could not be extraposed.

\ex.\label{ex:mg-extra}
\ag. Der Hans hat \tbf{was} \tbf{er} \tbf{gestohlen} \tbf{hat} zurückgegeben.\\
the Hans has what he stolen has returned\\
`Hans has returned what he has stolen.' \citet[185]{groos1981}\label{ex:mg-extra-no}
\bg. Der Hans hat zurückgegeben \tbf{was} \tbf{er} \tbf{gestohlen} \tbf{hat}.\\
