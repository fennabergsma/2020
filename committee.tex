...
Since this type of analysis requires a throrough investiation into gender systems, I leave investigating this options further for future research.
}
\footnote{
A third logical option is that both the vowels (\tit{o} and \tit{e}) and the consonants (\tsc{k} and \tsc{t}) have a different feature content.
}

I describe the situation in \ref{ex:e-o-phon-kt}.
...
I continue with the vowel, which is e. Another place for the e is jego.


I continue with the morphemes \tit{go} and \tit{mu}. Consider the Polish demonstratives and relative pronouns in Table x and y.
...
There are two constituents. The first constituent contains a number feature and case features up to the dative and corresponds to the morpheme \tit{mu}. The second constituent gender features up to the animate.
