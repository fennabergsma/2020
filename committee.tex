...
Does the committee internal? What kind of info does the committee use? it compared the non-case part of the internal and external element.
...
int is allows to surface when
the non-case part of int contains all features the non-case part of ext contains

ext is allows to surface when
the non-case part of ext contains all features the non-case part of int contains


Case differs per sentence, non-case part of int and non-case part of ext is fixed per language. The next section discusses what they are.
