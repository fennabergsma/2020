...
Then I discuss the light head. I argue that Modern German headless relatives are derived from a light-headed relative clause that never surfaces in the language. I decompose the light heads into morphemes, and I show which features each of the morphemes corresponds to.
...
In what follows, I argue that structure of the relative pronoun actually looks as in \ref{ex:mg-structure-rel}.

\ex.\label{ex:mg-structure-rel}
\scriptsize{
...
I discuss two relative pronouns. These are the two elements that I compare the constituents of at the end of this section. The two forms are the animate singulars in nominative and accusative case, given in \ref{ex:mg-rels}.
...
I decompose the relative pronouns in three morphemes: the \tit{w}, the \tit{e} and the final consonant. For each morpheme, I discuss which features they spell out and what their lexical entries look like. Then I give the feature content of relative pronouns as a whole. Finally, I show how relative pronouns are derived.

I start with the morpheme \tit{w} of the relative pronoun. Compare Table \ref{tbl:mg-paradigm-wh-rels} and Table \ref{tbl:mg-paradigm-wh-dem}. The \tit{w} combines with the same endings as the \tit{d} does in demonstratives (or relative pronouns in headed relatives).\footnote{
...
I continue with the final consonants (\tit{r} and \tit{n}). They can be observed in several contexts besides relative pronouns. Table \ref{tbl:mg-str-adj} gives an overview of strong adjective \tit{neu} `new' in Modern German in two numbers, three genders and three cases.\footnote{
...
This leaves the \tit{e} in the relative pronoun. I assume that, \tit{e} contains \tsc{ref}, which \citet{harley2002} claim all pronouns contain. Besides that, it expresses features involving deixis. Modern German has a syncretic form for the proximal, the medial and the distal \pgcitep{lander2018}{387}.
...
In Nanosyntax, lexical entries are not glued together directly from the lexicon. Instead, spellout happens in a cyclic derivation.
