...
\begin{table}[H]
 ...
 \caption {Modern German \tsc{int}\scsub{nom} vs. \tsc{ext}\scsub{nom} = \tit{wer}}
  \begin{tabular}[b]{c}
      ...
      \scriptsize{
      \begin{forest} boompje
        [\textcolor{DG}{\tsc{nom}P},edge=DG, s sep=40mm
            [\textcolor{DG}{\tsc{med}P},edge=DG,
            tikz={
            \node[label=below:\textcolor{DG}{\tit{ə}},
            draw,circle,DG,
            scale=0.95,
            fit to=tree]{};
            \node[
            ...
            fit to=tree]{};
                ...
                [\textcolor{DG}{\tsc{deix}\scsub{2}},edge=DG]
                [\textcolor{DG}{\tsc{prox}P},edge=DG
                    [\textcolor{DG}{\tsc{deix}\tsc{1}},edge=DG]
                    [\textcolor{DG}{\tsc{ind}P},edge=DG
                        [\textcolor{DG}{\tsc{ind}},edge=DG]
                        [\textcolor{DG}{\tsc{masc}P},edge=DG
                            [\textcolor{DG}{\tsc{masc}},edge=DG]
                            [\textcolor{DG}{\tsc{class}P},edge=DG
                                [\textcolor{DG}{\tsc{class}},edge=DG]
                                [\textcolor{DG}{\tsc{ref}},edge=DG]
                            ]
                        ]
                    ]
                ]
            ]
            [\textcolor{DG}{\tsc{nom}P},edge=DG,
            tikz={
...
`I invite who I like.' \flushfill{Modern German, adapted from \pgcitealt{vogel2001}{344}}\label{ex:mg-acc-nom-u-rep}
...
\begin{table}[H]
  \center
 \caption {Modern German \tsc{int}\scsub{nom} vs. \tsc{ext}\scsub{acc} ≠ \tit{wer}}
  \begin{tabular}[b]{c}
      \toprule
      \scriptsize{
          \begin{forest} boompje
      ...
      \scriptsize{
      \begin{forest} boompje
        [\textcolor{DG}{\tsc{acc}P},edge=DG, s sep=40mm
            [\textcolor{DG}{\tsc{med}P},edge=DG,
            tikz={
            \node[label=below:\textcolor{DG}{\tit{ə}},
            draw,circle,DG,
...
\exg. *Ich {lade ein}, ən \tbf{mir} \tbf{sympathisch} \tbf{ist}.\\
1\ac{sg}.\ac{nom} invite.\ac{pres}.1\ac{sg}\scsub{[acc]} \ac{dem}.\ac{an}.\ac{acc} 1\ac{sg}.\ac{dat} nice be.\ac{pres}.3\ac{sg}\scsub{[nom]}\\
`I invite who I like.' \flushfill{Modern German, adapted from \pgcitealt{vogel2001}{344}}\label{ex:mg-acc-nom-lh}

\begin{table}[H]
  \center
 \caption {Modern German \tsc{int}\scsub{nom} vs. \tsc{ext}\scsub{acc} ≠ \tit{ən}}
  \begin{tabular}[b]{c}
      \toprule
      \scriptsize{
          \begin{forest} boompje
