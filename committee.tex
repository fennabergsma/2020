...
Before I continue with the other four features, I briefly return to the change in the vowel in Table \ref{tbl:pol-rel-dem}. The \tit{k} /k/ combines with the \tit{o} /ɔ/, and the \tit{t} /t/ combines with the \tit{e} /ɛ/. I analyze this change as a phonological process, in which the vowel changes depending on the consonant (cluster). Specifically, I argue that there is an underlying /ɛ/ changes into a /ɔ/ when it follows the \tit{k}. I describe the situation in \ref{ex:e-o-phon-kt}.
