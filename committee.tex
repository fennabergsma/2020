...
So, we have the external head, which is a subset of whatever this is in the relative clause. Translating this to headless relatives, there is no overt NP, so we only see the relative pronoun. What features are in there? What is there to be copied? \tsc{rel}, phi features, and d/wh.
...
Let me show you what the structure of this relative pronoun is, and how I get there.
  ...
  \center
	\caption {Old High German: \ac{int} > \ac{ext}}
      ...
      \begin{forest} boom
        ...
        tikz={
        \node[label=below:\textcolor{DG}{\tit{-er}},
        draw,circle,
        scale=0.8,
        DG,
        fit to=tree]{};
...
\begin{table}[H]
  \center
	\caption {Old High German: \ac{int} < \ac{ext}}
      ...
      \ac{int}  &   \ac{ext} \\ \cmidrule{1-2}
      \begin{forest} boom
        [\textcolor{DG}{\tsc{rel}P}, s sep=20mm
...
The strong article is used when there is an anaphoric relation. It is often the case that there is a linguistic antecedent that is referred back to.
...
Weak articles are used when situational uniqueness is involved. Uniqueness can be globally or within a restricted domain. The discourse participants mutually shared knowledge that uniqueness holds.

\exg. Armstrong flog als erster zum Mond.\\
Armstrong flew as {first one} {to the\scsub{weak}} moon\\
`Armstrong was the first one to fly to the moon.'

Weak articles are used when strong articles cannot be used (because there is no antecedent), and an indefinite is not appropriate in the situation (Hawkins 1991, Heim1991), but there is still uniqueness.
...
Sie ist vom Mann, mit dem sie gestern ausgegangen ist, versetzt worden.

soooo, this 'm that I have here needs to go :) a relative clause cannot modify a weak thing?




Restrictive relative clauses only work with d-, non-restrictive can also work with contracted form.
