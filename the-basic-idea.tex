...
For the light head to be absent, it needs to form a constituent within the other element (i.e. the light head or the relative pronoun).
...
The first option is that the relative pronoun, which bears the internal case, appears as the surface pronoun. The second option is that the light head, which bears the external case, appears as the surface pronoun. The third option is that there is no grammatical form for the surface pronoun.
...
Summing up this section, I make four assumptions. First, headless relative clauses are derived from light-headed relatives. Light-headed relatives contain a light head and relative pronoun. Second, in a headless relative either the light head or the relative pronoun is deleted. This happens when one of them forms a constituent within the other.
