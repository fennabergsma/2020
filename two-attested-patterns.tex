...
\exg. Uns besucht, \tbf{wer} \tbf{Maria} \tbf{mag}.\\
 2\ac{pl}.\ac{acc} visit.\ac{pres}.3\ac{sg}\scsub{[nom]} \ac{rel}.\ac{an}.\ac{nom} Maria.\ac{acc} like.\ac{pres}.3\ac{sg}\scsub{[acc]}\\
...
\exg. Ich vertraue, wem Maria gefällt\\
 ...
 `I trust whoever pleases Maria.' \flushfill{Modern German, adapted from \pgcitealt{vogel2001}{345}}\label{ex:mg-dat-dat}
