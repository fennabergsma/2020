...
Table \ref{tbl:case-competition-none} illustrates what a the pattern for such a language looks like.
...
The relative pronoun \tit{thémo} `\ac{rel}.\ac{sg}.\ac{m}.\ac{dat}' appears in the external case: the dative. The relative pronoun is marked in bold, just like as the relative clause, showing that the relative pronoun patterns with the relative clause.
Examples in which the internal case is accusative, the external case is dative and the relative pronoun appears in accusative case are unattested.
...
The second aspect is whether the internal and the external case are allowed to surface when they wins the case competition. This differs across languages. There are three possible patterns: (1) a pattern in which the external or the internal case are allowed to surface when they win, (2) a pattern in which only the internal case is allowed to surface when it wins, and (3) a pattern in which only the external case is allowed to surface when it wins.
...
\begin{table}[H]
  \center
  \caption{Typology of case competition in headless relatives}
    \begin{tabular}{ccccc}
    \toprule
    \multicolumn{2}{c}{\ac{int}>\ac{ext}} & \multicolumn{2}{c}{\ac{ext}>\ac{int}} & language                                \\
    \cmidrule{1-2}                          \cmidrule{3-4}
    \ac{int}        & \ac{ext}              & \ac{int}        & \ac{ext}          &                                         \\
    \cmidrule{1-1}    \cmidrule{2-2}          \cmidrule{3-3}    \cmidrule{4-4}
    ✔               & *                     & ✔               & *                 & n.a.                                    \\
    ✔               & *                     & *               & ✔                 & Gothic, Old High German, Ancient Greek  \\
    ✔               & *                     & *               & *                 & Modern German                           \\
    {*}             & ✔                     & ✔               & *                 & n.a.                                    \\
    {*}             & ✔                     & *               & ✔                 & Old English, Modern Greek               \\
    {*}             & ✔                     & *               & *                 & Modern German                           \\
    {*}             & *                     & ✔               & *                 & n.a.                                    \\
    {*}             & *                     & *               & ✔                 & n.a.                                    \\
    {*}             & *                     & *               & *                 & Polish                                  \\
    \bottomrule
  \end{tabular}
    \label{tbl:typology-case-competition}
\end{table}
...
\begin{figure}[H]
  \centering
    ...
    {case competition?};
        \node (outcome1) [outcome, below of=question1, xshift=-2.5cm]
        {\ac{rel} = \ac{ext}};
            \node (example1) [example, below of=outcome1, yshift=1.2cm]
            {\footnotesize{e.g. Old English, Modern Greek}};
        \node (question2) [question, below of=question1, xshift=2.5cm]
        {\ac{int} as winner?};
            ...
            {\ac{ext} as winner?};
                ...
                {\ac{rel} = complex};
                    ...
                    {\footnotesize{e.g. Gothic, Old High German, Ancient Greek}};

    \draw [arrow] (question1) -- node[anchor=east] {no} (outcome1);
    ...
    \caption{Flow chart case competition}
    \label{fig:typology1}
\end{figure}
...
This example is compatible with three patterns. First, Old English could be a case competition language that only allows the external case to surface. In Table \ref{tbl:oe-poss1}, I marked the example \ref{ex:oe-dat-nom} in gray in the external-only pattern taken from Section \ref{sec:pattern-iii}.
...
Second, Old English could be a case competition language that allows the internal case and external case to surface. In Table \ref{tbl:oe-poss2}, I marked the example \ref{ex:oe-dat-nom} in gray in the internal-and-external pattern repeated from Section \ref{sec:pattern-i}.
...
Third, Old English could be a language without case competition that lets the relative pronoun appear in the external case. In Table \ref{tbl:oe-poss3}, I marked the example \ref{ex:oe-dat-nom} in gray in the always-external pattern repeated from \ref{tbl:no-case-competition-ext}.
...
This example is compatible with three patterns. First, Modern Greek could be a case competition language that only allows the external case to surface. In Table \ref{tbl:greek-poss1}, I marked the example \ref{ex:greek-acc-nom} in gray in the external-only pattern taken from Section \ref{sec:pattern-iii}.
...
Second, Modern Greek could be a case competition language that allows the internal case and external case to surface. In Table \ref{tbl:greek-poss2}, I marked the example \ref{ex:greek-acc-nom} in gray in the internal-and-external pattern repeated from Section \ref{sec:pattern-i}.
...
Third, Modern Greek could be a language without case competition that lets the relative pronoun appear in the external case. In Table \ref{tbl:greek-poss3}, I marked the example \ref{ex:greek-acc-nom} in gray in the always-external pattern repeated from \ref{tbl:no-case-competition-ext}.
...
This does not change the fact that Modern Greek always lets the relative pronoun appear in the external case.
...
\begin{figure}[H]
  \centering
    ...
    \caption{Typology of headless relatives}
    \label{fig:typology-headless-relatives}
\end{figure}
