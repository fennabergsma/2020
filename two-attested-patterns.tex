...
\begin{figure}[H]
  \centering
    ...
    {case competition?};
        \node (question4) [question, below of=question1, xshift=-4cm]
        {\ac{int}/\ac{ext}?};
            \node (outcome5) [outcome, below of=question4, xshift=-1.5cm]
            {\ac{int}};
                \node (example1) [example, below of=outcome5, yshift=1.2cm]
                {\footnotesize{n.a.}};
        ...
        \node (question2) [question, below of=question1, xshift=1.5cm]
        {\ac{int} as winner?};
            \node (outcome2) [outcome, below of=question2, xshift=-4cm]
            {*};
                \node (example2) [example, below of=outcome2, yshift=1.4cm]
                {\footnotesize{e.g. Polish}};
            \node (question3) [question, below of=question2, xshift=1.5cm]
            {\ac{ext} as winner?};
    ...
    \draw [arrow] (question2) -- node[anchor=east] {int} (outcome5);
    \draw [arrow] (question2) -- node[anchor=west] {ext} (outcome1);
    \end{tikzpicture}
