...
A third possibility logically exists. However, so the best of my knowledge, this pattern is not attested in any (past) natural language. It has been said about Greek, but I think this lanugage doesn't adhere to the case sacle. I give examples in the next section. It has also been said about Old Greek (but see ample examples here), but here is an example of why that's not the case:

\tit{φιλέω}/\tit{philéō} `to love' takes accusative, \tit{ἀποθνῄσκω}/\tit{apothnḗiskō} `to die'

\exg. ὃν οἱ θεοὶ φιλοῦσιν ἀποθνῄσκει νέος\\
hòn hoi theoì philoũsin apothnḗͅskei néos\\
\tsc{rel}.\ac{acc} the god.pl love.3rd.pl.pres.ind die.3rd.sg.pres.ind young\\
