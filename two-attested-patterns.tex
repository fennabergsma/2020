...
This does not change the fact that Modern Greek always lets the relative pronoun appear in the external case. Table \ref{tbl:no-case-competition-greek+gen} gives the overview of the Modern Greek data. I incorporated the clitic into the overview, and I marked the cell that corresponds to the example in \ref{ex:greek-nom-gen} in dark gray.
   ...
   \begin{tabular}{c|c|c|c}
    ...
    \textsubscript{\ac{int}} \textsuperscript{\ac{ext}}
       ...
       [\ac{acc}]
           ...
           \\ \cmidrule{1-4}
       [\ac{gen}]
           & \cellcolor{DG}\ac{nom} + \ac{cl}
           & \ac{acc} + \ac{cl}
           &
           \\
     \bottomrule
   \end{tabular}
  \label{tbl:no-case-competition-greek+gen}
 \end{table}
