...
%two reasons for nanosyntax: (1) clear connection between morphology and syntax and (2) differences between languages are formulated in terms of different lexical entries. there are universal fseqs and languages differ in in which groupings they spell out these fseqs, that's all. so there's no space for `special language specific' constraints
