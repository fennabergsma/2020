...
\ex. \tbf{The Elsewhere Condition} (\citealt{kiparsky1973}, formulated as in \citealt{caha2020a}):\\
...
The lexical entry in \ref{ex:icelandic-sie-lexicon} is not considered, because it does not contain \tsc{f3}.
...
Just as Khanty has a morpheme that shows up in the accusative, it also has a morpheme that shows up in the dative. This morpheme \tit{-na} combines with the phonological form for the accusative, which leads to the lexical entry given in \ref{ex:khanty-na-lexion}.
...
\end{forest}
\label{ex:khanty-luw-na-el-movement}
...
So, dark gray is dative against accusative, and dative always wins. Dative actually contains accusative.

%let this correspond to the cells below?
...
What seems to happen is that the bigger one, that one that contains the other wins. It has the strength to delete the other. Here there is dative against accusative.
