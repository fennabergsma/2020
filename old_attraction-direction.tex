...
Do these two empty elements make sense? I would suggest yes. We indenpendently see that the lower \tit{d}-element is optional in Old High German relative clauses. We can also independently observe that the head NP can be zero, in light headed relatives.
