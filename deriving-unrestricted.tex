...
In Chapter \ref{ch:typology}, I showed that Old High German is a language of the unrestricted type. In this chapter, I show that Old High German light heads and relative pronouns have this type of structure described in Figure \ref{fig:rel-lh-unres-simple-1}. I give a compact version of the structures in Figure \ref{fig:rel-lh-ohg}.
...
\begin{figure}[htbp]
  ...
  \begin{tabular}[b]{ccc}
      ...
      \bottomrule
  \end{tabular}
   \caption {\tsc{lh}-1 and \tsc{rp} in Modern German}
  \label{fig:rel-lh-ohg}
\end{figure}

Consider the first possible light head in Figure \ref{fig:rel-lh-ohg}.
...
Consider the relative pronoun in Figure \ref{fig:rel-lh-ohg}.
Relative pronouns in Old High German consist of two morphemes: the constituent that forms the light head (i.e. phi- and case features) and the \tsc{rel}P, again indicated by the circles. The \tsc{rel}P is spelled out as \tit{de}. %same as modern german, noly D
Throughout this chapter, I discuss the exact feature content of relative pronouns and light heads, I give lexical entries for them, and I show how these lexical entries form the constituents shown in Figure \ref{fig:rel-lh-ohg}.




In the second possible light head, the light head corresponds to the phi- and case-feature part of the relative pronoun plus an additional feature X. This feature X is also present in the morpheme that spells out the feature \tsc{rel}. The phi- and case-features are spelled out by a portmanteau morpheme, just as they are in the internal-only type of language. The feature X is spelled out by a separate morpheme, which is the same morpheme that spells out X plus the feature \tsc{rel}. This means that the features of the relative pronoun and the light head are spelled out in such a way that they form the constituents shown in Figure \ref{fig:rel-lh-unres-simple}.
