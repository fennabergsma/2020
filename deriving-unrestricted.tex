...
In the first possible light head, the light head corresponds to the phi and case feature part of the relative pronoun. Just as in the internal-only type of language, there are two lexical entries that spell out light heads and relative pronouns: a portmanteau for phi and case features and a separate lexical entry that spells out the feature \tsc{rel}. This means that the internal syntax of light heads and relative pronouns looks as shown in Figure \ref{fig:rel-lh-unres-simple}.
...
In the second possible light head, the light head corresponds to the phi and case feature part of the relative pronoun plus an additional feature X. This feature X is also present in the relative pronoun.

There are two lexical entries that spell out light heads and relative pronouns: a portmanteau for phi and case features and a separate lexical entry that spells out the features X and \tsc{rel}. This means that the internal syntax of light heads and relative pronouns looks as shown in Figure \ref{fig:rel-lh-unres-simple-2}.
