...
Both examples in \ref{ex:ohg-nom-nom-rep} can be the underlying light-headed relative clause for the headless relative. First I show the comparison of the two constituents for \ref{ex:ohg-nom-nom-elh} and then the one for \ref{ex:ohg-nom-nom-lh}.
...
%I show how this cannot be the case
\exg. ih bibringu fona iacobes samin endi fona iuda [n] \tbf{dher} \tbf{mina} \tbf{berga} \tbf{chisitzit}\\
