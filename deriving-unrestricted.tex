...
Then I give an example in which the internal accusative case is more complex than the external nominative case. I show that the grammaticality of this example can only be derived by taking the extra light head as the present light head and not the light head.
I end with an example in which the external accusative case is more complex than the internal nominative case. I show that the grammaticality of this example can only be derived by taking the light head as the present light head and not the extra light head.
...
In \ref{ex:ohg-nom-nom-elh}, the light head \tit{r} `\tsc{elh}.\ac{sg}.\ac{m}.\ac{nom}' appears in the nominative case. It is placed between square brackets because it does not surface.
...
both can derive the right result, first give one, then the other one
...
here give the one with light head
...
The surface pronoun is \tit{dhen} `\ac{dem}.\ac{sg}.\ac{m}.\ac{acc}'.
...
The relative pronoun \tit{dher} `\ac{rel}.\ac{sg}.\ac{m}.\ac{nom}' appears in the nominative case.
The light head  appears in the accusative case. This is the element that surfaces.
