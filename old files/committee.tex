...
First, the light-headed relative is derived from an existing light-headed relative, and the deletion of the light head is optional. Second, the light-headed relative is derived from a light-headed relative that does not surfaces in Modern German, and the deletion of the light head is obligatory.
For Modern German I concluded it was the second, and I proposed which features should be in there. This set of features in Polish corresponds to an extra light head like \tit{ego} or \tit{emu}, which are not attested as a light head in an existing light-headed relative in Polish.
...
Light-headed relatives, however,

\ex.
\ag. Czytam to co lubiȩ.\\
 read.1\tsc{sg} \tsc{dem} what like-1\tsc{sg}\\
\bg. Czytam wszystko co lubiȩ.\\
read.1\tsc{sg} everything what like-1\tsc{sg}\\ \flushfill{Polish, \pgcitealt{citko2004}{104}}
