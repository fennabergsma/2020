...
When the internal and the external case match, the light head consists of phi- and case-features. The relative pronoun consists of the same features plus an additional feature \tsc{rel}. The features of the light head structurally form a constituent within the relative pronoun. Therefore, the light head can be deleted, and the relative pronoun bearing the internal and external case surfaces.
...
When the external case wins the case competition, the relative pronoun consists of phi- and case-features and the feature \tsc{rel}. The light head lacks feature \tsc{rel} compared to the relative pronoun, but is contains a more complex case feature (\tsc{k}\scsub{2} in Figure \ref{tbl:overview-intonly}). Neither the light head nor the relative pronoun structurally forms a constituent within the other element. Therefore, none of the elements can be deleted, and there is no headless relative construction possible.
...
Relative pronouns in Modern German consist of two morphemes: the constituent that forms the light head (i.e. phi- and case features) and the \tsc{rel}P, again indicated by the circles.
...
I show the complete structure that I work towards in this section in \ref{ex:mg-rp}.
...
The \tit{n} is the nominative masculine singular, so it spells out the features \tsc{ref}, \tsc{cl}, \tsc{an}, \tsc{ind} \ac{f}1 and \tsc{f}2. The \tit{m} is the accusative masculine singular, so it spells out the features that the \tit{r} spells out plus \ac{f}3.
...
Starting from the bottom, these are pronominal feature \tsc{ref}, gender features \tsc{cl} and \tsc{an}, a number feature \tsc{ind}, operator features \tsc{wh} and \tsc{rel} and case features \tsc{k}.\footnote{
...
In Chapter \ref{ch:the-basic-idea}, I suggested that light heads consist of at least two features: ϕ and \tsc{k}. In this section, I specify the feature content of the light head in more detail.
