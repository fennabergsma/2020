...
First consider the situation in which the internal and the external case match. The light head consists of phi- and case-feature portmanteau. The relative pronoun consists of the same morpheme plus an additional morpheme that spells out the feature \tsc{rel}. The light head structurally forms a constituent within the relative pronoun. Therefore, the light head can be deleted, and the relative pronoun bearing the internal and external case surfaces.

Consider now the situation in the internal case wins the case competition. The light head consists of phi- and case-features. The relative pronoun consists of the same features plus an additional feature \tsc{rel} and a more complex case feature (\tsc{k}\scsub{2} in Figure \ref{tbl:overview-intonly}). The features of the light head structurally form a constituent within the relative pronoun. Therefore, the light head can be deleted, and the relative pronoun bearing the internal and external case surfaces.

Finally, consider the situation in which the external case wins the case competition. The relative pronoun consists of phi- and case-features and the feature \tsc{rel}. The light head lacks feature \tsc{rel} compared to the relative pronoun, but is contains a more complex case feature (\tsc{k}\scsub{2} in Figure \ref{tbl:overview-intonly}). Neither the light head nor the relative pronoun structurally forms a constituent within the other element. Therefore, none of the elements can be deleted, and there is no headless relative construction possible.
...
Crucially, the main claim I made in Chapter \ref{ch:the-basic-idea} remains unchanged: Modern German has a portmanteau for the features that correspond to phi- and case-features and a separate lexical entry for the features the light head does not contain.
...
In Chapter \ref{ch:the-basic-idea}, I suggested that the relative pronoun contains at least one features more than the extra light head. In my proposal, it is actually two features, namely \tsc{wh} and \tsc{rel}. This leaves the functional for the extra light head as shown in \ref{ex:fseq-elh}.
...
I derive this from the morphology of light head and relative pronouns in Modern German. The light head corresponds to a single lexical entry, which spells out phi- and case-features. The relative pronoun corresponds in addition to that to another lexical entry, one that amongst other spells out a relative feature. The Modern German light head and relative pronoun are schematically shown in Figure \ref{fig:rel-lh-mg-sum}.
