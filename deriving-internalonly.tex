...
\ex.\label{ex:mg-rels}
\ag. w-e-r\\
 `\tsc{rp}.\tsc{an}.\tsc{sg}.\tsc{nom}'\\
\bg. w-e-n\\
 `\tsc{rp}.\tsc{an}.\tsc{sg}.\tsc{acc}'\\
...
\ex.
\a. \label{ex:mg-spellout-rel-nom-preview}
...
\end{forest}
\end{adjustbox}
\b.\label{ex:mg-spellout-rel-acc-preview}
...
\ag. Hat r das schon gemacht?\\
 has he.\tsc{wk} that already done\\
 `Did he already do that?'
\bg. Ich wollte n gestern schon anrufen.\\
 I wanted him.\tsc{wk} yesterday already call\\
...
\exg. Uns besucht [r] \tbf{wen} \tbf{Maria} \tbf{mag}.\\
 we.\ac{acc} visit.3\ac{sg}\scsub{[nom]} \tsc{elh}.\ac{nom}.\tsc{an} \tsc{rp}.\ac{acc}.\tsc{an} Maria.\ac{nom} like.3\ac{sg}\scsub{[acc]}\\
