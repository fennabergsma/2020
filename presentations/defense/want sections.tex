...
\begin{frame}{Gen 1: the winner of the competition (German data, Vogel 2001)}
...
\begin{frame}{Whether the winner gets approved --- German (Vogel 2001)}
...
\begin{frame}{Gen 2: whether the winner gets approved (overview)}
...
\begin{frame}{Morphology and syntax}
...
\begin{frame}{The pattern in German}
...
\begin{frame}{Light head\scsub{nom} and relative pronoun\scsub{nom} in German}
...
\begin{frame}{Ligt head\scsub{nom} and relative pronoun\scsub{acc} in German}
...
\begin{frame}{Light head\scsub{acc} vs. relative pronoun\scsub{nom} in German}
...
\begin{frame}{Light head\scsub{acc} vs. relative pronoun\scsub{acc} in Polish}
...
\begin{frame}{Light head\scsub{acc} vs. relative pronoun\scsub{dat} in Polish}
...
\begin{frame}{Light head\scsub{dat} vs. relative pronoun\scsub{acc} in Polish}
