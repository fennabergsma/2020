...
`I invite whoever Maria also trusts.' \flushfill{Modern German, adapted from \pgcitealt{vogel2001}{344}}
}
...
`Who visits us, Maria likes.' \flushfill{Modern German, adapted from \pgcitealt{vogel2001}{343}}
}
...
`Who visits us, Maria trusts.' \flushfill{Modern German, adapted from \pgcitealt{vogel2001}{343}}
}
...
`I trust whoever Maria also likes.' \flushfill{Modern German, adapted from \pgcitealt{vogel2001}{345}}
}
...
\pause
  ...
  `Jan likes whoever he teases.' \flushfill{Polish, adapted from \citealt{citko2013} after \pgcitealt{himmelreich2017}{17}}
...
\pause
  ...
  `Jan trusts whoever he let into the house.' \flushfill{Polish, adapted from \citealt{citko2013} after \pgcitealt{himmelreich2017}{17}}
...
\exg. Jan lubi kogo -kolkwiek Maria lubi.\\
 ...
 `Jan likes whoever Maria likes.' \flushfill{Polish, adapted from \citealt{citko2013} after \pgcitealt{himmelreich2017}{17}}
...
\center
lexicon (Nanosyntax, \citealt{starke2009})
...
\begin{frame}[noframenumbering]{\tsc{acc}\scsub{ext} vs. \tsc{acc}\scsub{int} in Modern German}
...
\begin{frame}[noframenumbering]{\tsc{dat}\scsub{ext} vs. \tsc{acc}\scsub{int} in Modern German}
...
\begin{frame}[noframenumbering]{\tsc{acc}\scsub{ext} vs. \tsc{acc}\scsub{int} in Polish}
...
\begin{frame}[noframenumbering]{\tsc{dat}\scsub{ext} vs. \tsc{acc}\scsub{int} in Polish}
...
\begin{frame}[noframenumbering]{Three descriptive parameters generate four language types}
