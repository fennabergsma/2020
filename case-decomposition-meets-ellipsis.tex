...
Empirically, something is going wrong now: we want the marker to follow the pronoun, not precede it.
...
In Nanosyntax spellout targets constituents. So it is impossible to let accP spell out \tit{e:l} without spelling out also everything below it.
