...
\exg. enti aer antuurta demo \tbf{zaimo} \tbf{sprah}\\
3\tsc{sg.m.nom} reply.\tsc{3sg}.\tsc{past}\scsub{[dat]} \tsc{rel}.\ac{dat}.\tsc{m}.\tsc{sg} 3\tsc{sg.m.dat} speak.\tsc{3sg}.\tsc{past}\scsub{[nom]}\\
`he replied to the one who spoke to him' \flushfill{\ac{ohg}, \ac{mons} 7:24, adapted from \pgcitealt{pittner1995}{199}}\label{ex:ohg-dat-nom}
...
The internal case is accusative. The predicate \tit{zéllent} `to tell' takes accusative objects.
The external case is nominative. The predicate \tit{ist} `to be' takes nominative objects.
...
`This is the one whom they talk about and whom they want to kill.' \flushfill{\ac{ohg}, ?}\label{ex:ohg-nom-acc}
...
`To whom less is read, loves less.' \flushfill{\ac{ohg}, ?}\label{ex:ohg-nom-dat}
...
\tsc{rel}.\tsc{dat}.\tsc{m}.\tsc{sg} against \tsc{dem}.\tsc{acc}.\tsc{n}.\tsc{sg} not do.3\tsc{sg} kommen/herankommen/zurück-.3\tsc{sg} sad.\tsc{nom}.\tsc{sg} heart.\tsc{nom}.\tsc{sg} and live.3\tsc{sg} 3.\tsc{sg}.\tsc{m}.\tsc{acc} über god.\tsc{gen}.\tsc{sg} rage.\tsc{sg}\\
`He does not do that to him, who the sad heart comes and lives him over God's rage.' \flushfill{\ac{ohg}, ?}\label{ex:ohg-acc-dat}
