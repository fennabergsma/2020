...
\tsc{rel}.\tsc{dat}.\tsc{m}.\tsc{sg} dagegen \tsc{dem}.\tsc{acc}.\tsc{n}.\tsc{sg} not tun/machen.3\tsc{sg} kommen/herankommen/zurück-.3\tsc{sg} sad.\tsc{nom}.\tsc{sg} heart.\tsc{nom}.\tsc{sg} and live.3\tsc{sg} 3.\tsc{sg}.\tsc{m}.\tsc{acc} über god.\tsc{gen}.\tsc{sg} rage.\tsc{sg}\\
`'
