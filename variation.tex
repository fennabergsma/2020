...
The internal case is accusative. The predicate \tit{mag} `likes' takes accusative objects.
The external case is dative. The predicate \tit{vertraue} `trust' takes dative objects.
The relative pronoun \tit{wem} `\tsc{rel}.\ac{dat}.\tsc{an}' appears in the external case: the dative. The relative pronoun is marked in bold, just like as the relative clause, showing that the relative pronoun patterns with the relative clause.
...
`I trust whoever Maria also likes.' \flushfill{\pgcitealt{vogel2001}{345}}\label{ex:mg-dat-acc}
...
The internal case is nominative. The predicate \tit{mag} `likes' takes nominative subjects.
The external case is dative. The predicate \tit{vertraue} `trust' takes dative objects.
The relative pronoun \tit{wem} `\tsc{rel}.\ac{dat}.\tsc{an}' appears in the external case: the dative. The relative pronoun is marked in bold, just like as the relative clause, showing that the relative pronoun patterns with the relative clause.
This is ungrammatical in German: only the internal case can win.
...
`I trust who likes Hitchcock.' \flushfill{\pgcitealt{vogel2001}{345}}\label{ex:mg-dat-nom}
...
The internal case is nominative. The predicate \tit{mir sympathisch ist} `I like' takes nominative subjects.
The external case is dative. The predicate \tit{vertraue} `trust' takes dative objects.
The relative pronoun \tit{wen} `\tsc{rel}.\ac{acc}.\tsc{an}' appears in the external case: the accusative. The relative pronoun is marked in bold, just like as the relative clause, showing that the relative pronoun patterns with the relative clause.
This is ungrammatical in German: only the internal case can win.

\exg. *Ich {lade ein}, wen \tbf{mir} \tbf{sympathisch} \tbf{ist}.\\
I invite\scsub{[acc]} \tsc{rel}.\ac{acc}.\tsc{an} me nice is\scsub{[nom]}\\
`I invite who I like.' \flushfill{\pgcitealt{vogel2001}{344}}\label{ex:mg-acc-nom}
