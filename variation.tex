...
The examples below follow the spelling and the detailed glosses in ANNIS. I adapted the translations from earlier secondary literature when available.
...
%%the voice of god speaks through jesaja:

\exg. ``Ih bibringu (fona iacobes samin endi fona iuda) dhen mina berga chisitzit.''\\
1\tsc{sg}.\tsc{nom} {give rise to/send}.\tsc{1sg} from Jakob.\tsc{gen} Samuel.\tsc{dat} and from Judas.\tsc{abl} \tsc{rel}.\tsc{acc}.\tsc{m}.\tsc{sg} my.\tsc{acc}.\tsc{m}.\tsc{pl} mountain.\tsc{acc}.\tsc{pl} possess.3\tsc{sg}\\
`I give rise to (from Samuel of Jakob and from Judas) him who possesses my mountains.' \flushfill{\ac{ohg}, \ac{isid} 34:3, adapted from \pgcitealt{behaghel1923}{761}}\label{ex:ohg-acc-nom}
...
`This is the one whom they talk about and whom they want to kill.' \flushfill{\ac{ohg}, Otfrid}\label{ex:ohg-nom-acc}
...
`To whom less is read, loves less.' \flushfill{\ac{ohg}, Tatian}\label{ex:ohg-nom-dat}
...
The external case is nominative. The predicate \tit{minnot} `to love' takes nominative subjects.
The relative pronoun \tit{themo} `\ac{rel}.\ac{dat}.\ac{m}.\ac{sg}' appears in the internal case: the dative. The relative pronoun is marked in bold, just like as the relative clause, showing that the relative pronoun patterns with the relative clause.


%%%check whether thingy really had this as an example that does this

\exg. Themo avur tház ni gidúat, quimit séragaz muat, joh wónot inan úbari gotes ábulgi!\\
\tsc{rel}.\tsc{dat}.\tsc{m}.\tsc{sg} but \tsc{dem}.\tsc{acc}.\tsc{n}.\tsc{sg} not do.3\tsc{sg} come.3\tsc{sg} sad.\tsc{nom}.\tsc{sg} heart.\tsc{nom}.\tsc{sg}
and live.3\tsc{sg} 3.\tsc{sg}.\tsc{m}.\tsc{acc} over god.\tsc{gen}.\tsc{sg} rage.\tsc{sg}\\
`He does not do that to him, who the sad heart comes, and he lives in God's rage.' \flushfill{\ac{ohg}, Otfrid}\label{ex:ohg-acc-dat}
...
\exg. tház si uns béran scolti \tbf{thér} \tbf{unsih} \tbf{gihéilti}\\
 that 3\tsc{sg.f.nom} 1\tsc{pl.dat} bear should.\tsc{subj}.\tsc{past}.\tsc{3sg} \tsc{rel}.\tsc{nom}.\tsc{m}.\tsc{sg} 1\tsc{pl.acc} save.\tsc{subj.past}.\tsc{3sg}\\
 `that she should bear for us him who will save us' \flushfill{\ac{ohg}, \ac{otfrid}}\label{ex:ohg-counterexample}
