...
First I introduce the pattern that forms the focus of the first part of the dissertation. I show that headless relatives adhere to the case scale: \ac{nom} < \ac{acc} < \ac{dat}.
...
\section{Case competition in headless relatives}
