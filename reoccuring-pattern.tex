...
\a. \ac{acc} wins over \ac{nom}
\b. \ac{dat} wins over \ac{nom}
\b. \ac{dat} wins over \ac{acc}
...
\exg. (Én) neked ad -om a könyv -et\\
 I you.\ac{dat}.\ac{sg} give -\tbf{1\ac{sg}.\ac{subj}>3.\ac{obj}} the book -\ac{acc}\\
...
In the.winter were.PL the.king.\ac{dat} given slaves.\ac{nom}\\
...
\citealt{caha2009} restates the implicational hierarchy in terms of case. Again, the case scale can be observed: \ac{nom} < \ac{acc} < \ac{dat}.
