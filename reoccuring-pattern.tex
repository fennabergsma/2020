...
He gives examples of situations in which grammatical function and morphological case do not match. In these situations, case seem to be capture the facts for the implicational hierarchy. I give examples from Icelandic that illustrate this point.
...
\exg. *Morgum studentum líka verkið.\\
 many students.\tsc{dat} like-PL job.\tsc{nom} \\
`Many students like the job.' \flushfill{Harley 1995, 208}
...
`In the winter, the king was given (female) slaves.' \flushfill{Zaenen et al, 112}

In the languages I discuss in this dissertation, I focus on languages that have nominative as default case and accusative as dependent case. That is, \posscitealt{bobaljik2006} schema translates into Figure \ref{fig:agr-nom-acc-dat}.
...
In conclusion, agreement follows the same implicational hierarchy as the strength hierarchy in headless relatives: \tsc{nom} --- \tsc{acc} --- \tsc{dat}.
