...
all arguments to the left of X.
...
\begin{tikzpicture}
  ...
  \draw[decoration={text along path,reverse path,text align={align=center},text={IO}},decorate] (0.6,-1) arc (0:1:0.5);
  \draw[decoration={text along path,reverse path,text align={align=center},text={DO}},decorate] (0.6,0.25) arc (0:180:0.5);
  \draw[decoration={text along path,reverse path,text align={align=center},text={S}},decorate] (0,1.5) arc (0:180:0.5);
\end{tikzpicture}
...
% Is the segmentation and glossing correct? I took the example from the literature but they were not very clear about which morpheme does what exactly. And the agreement, would you say it agrees in number, person and definiteness?
