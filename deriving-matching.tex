...
In all three forms there is a syncretism between the neuter and the masculine in the dative case. They are the  The complete pronouns are syncretic. I set up a system that can derive the syncretism between the two genders. Doing this allows me to establish which features the morpheme \tit{mu} spells out.
...
\begin{table}[htbp]
  ...
  \begin{tabular}[b]{ccc}
    ...
    \tit{nie}-pronoun & n-i-o-mu    &  n-i-e-mu \\
    \tit{je}-pronoun  & i-o-mu      &  j-e-mu   \\
    \bottomrule
  \end{tabular}
