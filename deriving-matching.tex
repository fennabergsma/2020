...
Languages of the matching type can be summarizes as in Table \ref{tbl:overview-rel-light-pol}.
...
In this section I discuss the internal structure of relative pronoun in Polish headless relatives. In Chapter \ref{ch:deriving-onlyinternal} I argued that Modern German relative pronouns consist of the features given in the functional sequence in \ref{ex:pol-fseq-rel}.
