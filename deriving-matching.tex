...
First consider the situation in which the internal and the external case match. The light head consists of phi-feature morpheme and a case-feature morpheme. The relative pronoun consists of the same morphemes plus an additional morpheme that spells out the feature \tsc{rel}. The light head structurally forms a constituent within the relative pronoun. Therefore, the light head can be deleted, and the relative pronoun bearing the internal and external case surfaces.
In this situation, the fact that there is a phi- and case-feature portmanteau (as in internal-only languages) or two separate morphemes for the features (as in matching languages) does not make a difference for the containment relation.
...
In Chapter \ref{ch:deriving-internalonly}, I suggested that Modern German relative pronouns consist of the features in the following functional sequence.
...
I start with the suffixes \tit{go} and \tit{mu}. First I focus on \tit{mu}.
...
In what follows, I show how I can derive the syncretisms for the forms in Table \ref{tbl:pol-datives}. Different from \tit{jullie}, these forms consists of two morphemes: \tit{je}/\tit{nie}/\tit{te} and \tit{mu}.
I do not discuss the feature content of the morphemes \tit{je}, \tit{nie} and \tit{te}, but I know that all three forms combined with \tit{mu} spell out at least the features I give in \ref{ex:pol-mu-dat-fseq}.
...
In \ref{ex:pol-spellout-nie/je/te-an}, I give the syntactic structure of a masculine form. The syntactic structure forms a constituent within the lexical tree in \ref{ex:pol-entry-nie/je/te}, and the structure can be spelled out as \tit{je/nie/te}.
...
In \ref{ex:pol-spellout-nie/je/te-cl}, I give the syntactic structure of a masculine form. The syntactic structure forms a constituent within the lexical tree in \ref{ex:pol-entry-nie/je/te}, and the structure can be spelled out as \tit{je/nie/te}.
...
What follows from this is that the lexical trees for the suffix \tit{mu} should contain all features in \ref{ex:pol-elh-dat} that are not spelled out by \tit{je/nie/te} so far. These are the feature \tsc{ind} and all case features up to the dative. I give the lexical entry for \tit{mu} in \ref{ex:pol-entry-mu}.
...
This leaves the two morphemes \tit{k} and \tit{o}. First I discuss the \tit{o}. Consider the relative pronouns in Table \ref{tbl:pol-rps}.
...
In the introduction of this chapter, I suggested that in Polish features of the light head are spelled out in such a way that they form the constituency shown in \ref{ex:pol-lh-complex}.
