...
I do not discuss the feature content of the morphemes \tit{je}, \tit{nie} and \tit{te}, but I call them XP.
...
This distinguishing feature is the feature \tsc{an} \citep{harley2002}, which is not the the highest feature in \ref{ex:pol-mu-dat-fseq}. Fortunately, different from \tit{jullie}, the forms are bimorphemic: they contain morphemes \tit{je}, \tit{nie} or \tit{te} and the morpheme \tit{mu}.
Now the highest feature of one of the two morphemes needs to be the feature \tsc{an}.

If the feature \tsc{an} can be either present or absent, the forms can easily spell both the structure with or without the feature \tsc{an}. Therefore, the lexical entry is as given in \ref{ex:pol-entry-nie/je/te}.
