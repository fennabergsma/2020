...
The features that are not contained in the extra light head are \tsc{wh} and \tsc{rel}. In addition, I propose that \tit{k} also spells out the features \tsc{ind}, \tsc{an} and \tsc{cl}.
...
Until the feature \tsc{ind}, the derivation is identical to the one of the extra light. Therefore, I start at point at which the feature \tsc{wh} is merged.
